...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative z-20 overflow-hidden bg-[#080405]">
      
      {/* 1. Sculpted White Silk Wave Ribbon CTA Banner */}
      ...
      {/* Main Sculpted White Silk Ribbon Canvas */}
      <div className="bg-gradient-to-b from-[#f8fafc] via-[#fcfdfe] to-[#f8fafc] text-slate-800 py-16 sm:py-24 px-6 lg:px-12 relative z-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="max-w-xl text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-red-600 text-xs font-bold tracking-wider uppercase mb-5 shadow-sm border border-red-200">
              <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
              <span>LET'S WORK TOGETHER</span>
            </div>

            <h2 className="text-4xl sm:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-5">
              Have a <span className="font-serif italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-500">project</span> <br />
              in mind?
            </h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider text-white bg-slate-900 hover:bg-gradient-to-r hover:from-red-600 hover:to-orange-500 shadow-lg hover:shadow-xl hover:scale-102 active:scale-98 transition-all duration-300 group"
            >
          ...
          <div className="relative w-72 h-72 sm:w-88 sm:h-88 md:w-96 md:h-96 flex items-center justify-center group select-none">
            ...
            <div className="absolute bottom-1 inset-x-10 h-16 bg-orange-400/30 rounded-full blur-xl group-hover:bg-orange-400/45 transition-all duration-700 pointer-events-none" />
            ...
            <div className="relative w-full h-full flex items-center justify-center animate-float z-10">
              <img
                ...
                className="w-full h-full object-contain mix-blend-multiply filter contrast-[112%] brightness-[103%] hue-rotate-[165deg] drop-shadow-[0_20px_35px_rgba(249,115,22,0.35)] group-hover:scale-105 transition-transform duration-700"
                onError={(e) => {
      ...
      {/* Bottom Wave Transition: White Silk Ribbon to Dark */}
      ...
      <div id="contact-form-area" className="py-20 bg-[#080405] relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none">
          <img
            ...
            className="w-full h-full object-cover object-center opacity-60 mix-blend-screen filter hue-rotate-[165deg] saturate-[2] brightness-105"
            style={{
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/70 border border-white/10 hover:border-red-500/50 transition-all group"
              >
                <div className="w-10 h-10 rounded-xl bg-red-950/80 border border-red-500/20 flex items-center justify-center text-red-400 group-hover:scale-110 transition-transform shadow-[0_0_12px_rgba(239,68,68,0.2)]">
                  <Mail className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] text-red-300/90 block font-bold uppercase tracking-wider">Email</span>
                  <span className="text-xs sm:text-sm font-bold text-white group-hover:text-orange-300 transition-colors">
                    {personal.email}
                  </span>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/70 border border-white/10 hover:border-orange-500/50 transition-all group"
              >
                <div className="w-10 h-10 rounded-xl bg-orange-950/80 border border-orange-500/20 flex items-center justify-center text-orange-400 group-hover:scale-110 transition-transform shadow-[0_0_12px_rgba(249,115,22,0.2)]">
                  <Phone className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] text-orange-300/90 block font-bold uppercase tracking-wider">WhatsApp / Phone</span>
                  <span className="text-xs sm:text-sm font-bold text-white group-hover:text-orange-300 transition-colors">
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/70 border border-white/10">
                <div className="w-10 h-10 rounded-xl bg-slate-900 border border-white/10 flex items-center justify-center text-orange-400">
                  <MapPin className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] text-orange-300/90 block font-bold uppercase tracking-wider">Location</span>
              ...
              <div className="flex items-center gap-3 pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold bg-slate-950/70 border border-white/10 text-slate-100 hover:text-white hover:border-red-400 transition-all"
                >
            ...
            <div className="lg:col-span-7">
              <div className="bg-slate-950/70 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 shadow-card-elevated">
                ...
                {isSuccess && (
                  <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center gap-3 text-emerald-300 text-xs">
                    ...
                    <span>Thank you! Your message has been received. {personal.firstName} will respond promptly.</span>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        style={{ backgroundColor: '#0d0407', color: '#ffffff', caretColor: '#ef4444' }}
                        className="w-full px-3.5 py-2.5 rounded-xl !bg-[#0d0407] !text-white border border-white/10 focus:border-red-400 focus:ring-1 focus:ring-red-400/30 text-white text-xs placeholder:text-slate-400 outline-none transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-[11px] font-bold text-slate-100 uppercase tracking-wider mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      style={{ backgroundColor: '#0d0407', color: '#ffffff', caretColor: '#ef4444' }}
                      className="w-full px-3.5 py-2.5 rounded-xl !bg-[#0d0407] !text-white border border-white/10 focus:border-red-400 focus:ring-1 focus:ring-red-400/30 text-white text-xs placeholder:text-slate-400 outline-none transition-all resize-y"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-full text-xs font-bold uppercase tracking-wider text-white bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 shadow-[0_0_20px_rgba(239,68,68,0.4)] transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer"
                  >
